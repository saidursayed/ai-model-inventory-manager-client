            ...
            >
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-5 min-w-0">
                <img
                  src={model.image}
                  alt={model.name}
                  className="w-20 h-20 sm:w-24 sm:h-24 rounded-lg object-cover bg-gray-100 dark:bg-slate-700 p-2 transition-transform duration-500 hover:scale-105 shrink-0"
                />
              ...
              <Link
                ...
                className="w-full md:w-auto text-center relative overflow-hidden rounded-lg border border-indigo-600 text-white bg-indigo-600 px-5 py-2 font-semibold transition-all duration-300 group flex justify-center items-center"
              >

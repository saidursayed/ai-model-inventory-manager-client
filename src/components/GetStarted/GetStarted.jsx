  ...
  return (
    <section className="relative py-20 md:py-28 bg-[#E5E5FD] dark:bg-[#020617] overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 text-center">
        <div className="inline-block bg-white/60 dark:bg-white/10 px-4 py-2 rounded-full text-sm text-indigo-600 dark:text-indigo-200 mb-6 border border-white/40 dark:border-white/10 font-medium">
        ...
        <p className="text-gray-600 dark:text-slate-300 text-lg md:text-xl mt-6">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-8 text-gray-700 dark:text-slate-300 text-sm md:text-base">
          <span data-aos="fade-right" className="bg-white/70 dark:bg-white/10 px-4 py-2 rounded-lg border border-white/50 dark:border-white/10">
            Manage AI Models
          </span>
          <span data-aos="fade-down" className="bg-white/70 dark:bg-white/10 px-4 py-2 rounded-lg border border-white/50 dark:border-white/10">
            Track Datasets & Frameworks
          </span>
          <span data-aos="fade-left" className="bg-white/70 dark:bg-white/10 px-4 py-2 rounded-lg border border-white/50 dark:border-white/10">
